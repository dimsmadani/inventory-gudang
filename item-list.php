        ...
        if(add_item($_POST) > 0)
        {
            echo "
                <script>
                    ...
                    document.location.href = 'item-list.php';
                </script>
            ";
        }
        else
...
<head>
    ...
    <title>Item List - Admin Dashboard</title>
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Item List</h3>
                        <p class="text-subtitle text-muted">For user to check item list</p>
                    </div>
                    ...
                    <div class="card-body">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="name"
                                                                ...
                                                                placeholder="Input Item Name" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                        ...
                        <table class="table table-striped" id="table1">
                            ...
                            <tbody>
                                <?php 
                                    $sSQL="";
                                    $sSQL="SELECT tb_item.id, tb_item.name, tb_category.category, tb_item.description 
                                        FROM tb_item INNER JOIN tb_category ON tb_item.category = tb_category.id order by name";
                                    $result=mysqli_query($conn, $sSQL);
                                ...
                                ?>		
                                            <tr>
                                                ...
                                                <td width="4%">
                                                    <a href="update_item.php?id=<?php echo $row["id"] ?>"><button class='btn btn-primary'>UPDATE</button></a>
                                                </td>
                                            </tr>   
                                <?php	   
                                        }
            ...
            <div class="footer clearfix mb-0 text-muted">
                ...
                <div class="float-end">
                    <p>Crafted with <span class="text-danger"><i class="bi bi-heart"></i></span> by <a
                            href="mailto:dimasmadani44@gmail.com">Dimas Madani</a></p>
                </div>
            </div>
        </footer>
    </div>
