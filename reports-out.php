...
<head>
    ...
    <title>Out of Stock Reports - Admin Dashboard</title>
...
<body>
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Out of Stock Reports</h3>
                        <p class="text-subtitle text-muted">For user to check out of stock reports</p>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Out of Stock Reports</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        <div class="row g-3">
                            <div class="col-auto">
                                <form class="form form-horizontal" action="reports-out.php" method="POST" name="myForm" id="form-id">
                                ...
                                <?php 
                                    if(isset($_POST["submit"]))
                                    {
                                        ...
                                        $sSQL="SELECT tb_outstock.id, tb_item.name, tb_supplier.name AS supplier, tb_category.category, tb_outstock.date, 
                                            ...
                                            WHERE tb_outstock.date BETWEEN '$date1' AND '$date2'+INTERVAL 1 DAY ORDER BY date";
    ...
    <script type='text/javascript'> 
        function printContent(el) {
            ...
            $("#title").html("<br>Out of Stock Reports");
