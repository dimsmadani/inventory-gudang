<?php
    ...
    function forgot_password($data)
    {
        ...
        if(mysqli_num_rows($result) > 0)
        {
            ...
            $output.='<p>-------------------------------------------------------------</p>';
            $output.='<p><a href="localhost/warung/reset-password.php?key='.$key.'&id='.$id.'&action=reset" target="_blank">
            https://localhost/warung/reset-password.php?key='.$key.'&id='.$id.'&action=reset</a></p>';		
            $output.='<p>-------------------------------------------------------------</p>';
