            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Item Category</h3>
                        <p class="text-subtitle text-muted">For user to check item category list</p>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <input type="text" id="category" class="form-control"
                                            name="category" placeholder="Input Product Category" autocomplete="off">
                                    </div>
                                    <div class="col-md-2">
                        ...
                        <tbody>
                            ...
                            ?>		
                                        <tr>
                                            ...
                                            <td width="4%">
                                                <a href="update_category.php?id=<?php echo $row["id"] ?>"><button class='btn btn-primary'>UPDATE</button></a>
                                            </td>
                                        </tr>   
                            <?php	   
                                    }
