            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Supplier List</h3>
                        <p class="text-subtitle text-muted">For user to check supplier list</p>
                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="name"
                                                                ...
                                                                placeholder="Input Name Supplier" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" id="telephone"
                                                                ...
                                                                placeholder="Input Telephone Supplier" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="address"
                                                                ...
                                                                placeholder="Input Address Supplier" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                        ...
                        <tbody>
                            ...
                            ?>		
                                        <tr>
                                            ...
                                            <td width="4%">
                                                <a href="update_suppliers.php?id=<?php echo $row["id"] ?>"><button class='btn btn-primary'>UPDATE</button></a>
                                            </td>
                                        </tr>   
                            <?php	   
                                    }
