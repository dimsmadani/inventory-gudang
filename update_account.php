<?php 
    ...
    $id=$_GET['id'];
    //$id = $_SESSION['id'];
    $result=mysqli_query($conn, "SELECT * FROM tb_account where id='$id' limit 1");
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        ...
                        <p class="text-subtitle text-muted">For user to update account</p>
                    </div>
            ...
            <section class="section">
                <div class="card">
                    <form class="form form-vertical" action="" method="post">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select id="type" class="form-control" name="type">
                                        <option value="<?=$type1;?>"><?php echo $type1;?></option>
                                        <?php 
                                            if($type == "Admin")
                                            {
                                        ?>
                        ...
                        <a href="account-list.php" class="btn btn-light-secondary me-1 mb-1" role="button" aria-pressed="true">Cancel</a>
